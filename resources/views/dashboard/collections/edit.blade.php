...
@section('content')
    ...
    <div class="col-lg-8">
        <form method="POST" action="{{route('collections.update', $collection)}}" class="mb-5" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('collectionName') is-invalid @enderror" id="collectionName" name="collectionName"
                       required autofocus value="{{old('collectionName', $collection->collectionName)}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('collectionCode') is-invalid @enderror" id="collectionCode" name="collectionCode"
                       required value="{{ old('collectionCode', $collection->collectionCode) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('collectionAuthor') is-invalid @enderror" id="collectionAuthor" name="collectionAuthor"
                       required value="{{ old('collectionAuthor', $collection->collectionAuthor) }}">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('collectionPublisher') is-invalid @enderror" id="collectionPublisher" name="collectionPublisher"
                               required value="{{ old('collectionPublisher', $collection->collectionPublisher) }}">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('collectionPublishYear') is-invalid @enderror" id="collectionPublishYear" name="collectionPublishYear"
                               required value="{{ old('collectionPublishYear', $collection->collectionPublishYear) }}">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="collectionType">
                    @foreach ($collectionTypes as $collectionType)
                        @if (old('collectionType', $collection->collectionTypeID) === $collectionType->id)
            ...
            <div class="mb-3">
                ...
                @if($collection->collectionImage)
                    <img src="{{asset('storage/'.$collection->collectionImage)}}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
