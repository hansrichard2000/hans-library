...
@section('title')
    Tambah Tipe Koleksi | Perpustakaan Hans
@endsection

@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1>Tambah Tipe Koleksi</h1>
    </div>

    <div class="card shadow p-3 mb-5 bg-body rounded">
        <div class="card-body">
            <form action="{{route('collection-type.store')}}" method="POST">
                @csrf
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control @error('collectionTypeName') is-invalid @enderror" id="collectionTypeName" name="collectionTypeName"
                           required autofocus value="{{ old('collectionTypeName') }}">
